            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form name="form-<?=str_replace('_','-',$prefix)?>" class="formValidate">
                        <input type="hidden" class="" id="<?=$prefix?>_id_setor" name="<?=$prefix?>_id_setor" value="">
                        <div class="form-group">
                            <label for="<?=$prefix?>_nome">Descrição</label>
                            <input type="text" class="form-control requered" id="<?=$prefix?>_nome" name="<?=$prefix?>_nome" placeholder="Nome do Setor">
                        </div>
                        <div class="form-group">
                ...
                [
                    ...
                    { "data": function ( data, type, row ) {
                                    ...
                                    <?php if(in_array('ALTERAR', $arr_permissoes)):?>
                                        campo+= '<a href="#" title="Editar" id="'+data.id_setor+'" rel="btn-<?=str_replace('_','-',$prefix)?>-editar" role="button" class="btn btn-primary btn-sm" style="margin: 1px 2px">'+
                                                    '<i class="fas fa-edit"></i>'+
                                                '</a>';
                                    <?php endif;?>

                                    <?php if(in_array('DELETAR', $arr_permissoes)):?>
                                        campo+= '<a href="#" title="Deletar" rel="btn-<?=str_replace('_','-',$prefix)?>-deletar" id="'+data.id_setor+'" role="button" class="btn btn-danger btn-sm" style="margin: 1px 2px">'+
