            ...
            <div class="container-fluid">
                ...
                <div class="card text-center">
                    <div class="card-header">
                        <h6 class="m-0 font-weight-bold text-primary" id="div_titulo_auto_fracionamento">Passe o
                            Material no Leitor</h6>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <?php if ($arr_computadores && isset($arr_computadores) && count($arr_computadores) > 0): ?>
                                ...
                                <?php else: ?>
                                    <div class="col-lg-4 col-xl-4 col-xxl-4">
                                        <input type="hidden" class="form-control" id="arr_computadores" name="arr_computadores"
                                            value="<?= $arr_computadores[0]['chave'] ?>">
                                    </div>
                                <?php endif; ?>
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 col-xxl-4">
                                ...
                                <input type="text" class="form-control text-center" aria-label="Large"
                                    id="cod_barras_material" aria-describedby="inputGroup-sizing-sm">
                            </div>
                            <div class="col-lg-4 col-xl-4 col-xxl-4"></div>
                        </div>
                        <br>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.success) {
                        ...
                        const etiqueta = 'https://www.ootech.com.br/fracionar-imprimir-material/' + data.id_etiquetas + '';
