...
$titulo = 'Modo de conservação';
$prefix = 'modo_conservacao';
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form name="form-<?=$prefix?>" class="formValidate">
                        <input type="hidden" class="" id="<?=$prefix?>_id" name="<?=$prefix?>_id" value="">
                ...
                [
                    ...
                    { "data": function ( data, type, row ) {
                                    ...
                                    <?php if(in_array('ALTERAR', $arr_permissoes)):?>
                                        campo+= '<a href="#" title="Editar" id="'+data.id+'" rel="btn-<?=$prefix?>-editar" role="button" class="btn btn-primary btn-sm" style="margin: 1px 2px">'+
                                                    '<i class="fas fa-edit"></i>'+
                                                '</a>';
                                    <?php endif;?>
                                    
                                    <?php if(in_array('DELETAR', $arr_permissoes)):?>
                                        campo+= '<a href="#" title="Deletar" rel="btn-<?=$prefix?>-deletar" id="'+data.id+'" role="button" class="btn btn-danger btn-sm" style="margin: 1px 2px">'+
