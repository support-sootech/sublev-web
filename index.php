...
// ADIÇÃO: garante PDO global sem ruído
require_once __DIR__ . "/_pdo_boot.php";
// ADIÇÃO: helper robusto de headers
require_once __DIR__ . "/controller/_headers-helper.php";
...
// ADIÇÃO: deixa $app acessível no helper de headers
$GLOBALS['app'] = $app;
...
include_once('controller/app.etiquetas.php');
